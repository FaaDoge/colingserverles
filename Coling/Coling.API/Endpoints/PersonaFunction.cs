...
namespace Coling.API.Afiliados.Endpoints
{
    public class PersonaFunction
    {
        ...
        public async Task<HttpResponseData> ListarPersonaId([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "listarpersonas/{id:int}")] HttpRequestData req, int id)
        {
            _logger.LogInformation("Ejecutando azure function para isnertar personas.");
            try
            {
        ...
        [HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "modificarpersona/{id}")] HttpRequestData req,
        int id)
        {
    ...
    [HttpTrigger(AuthorizationLevel.Anonymous, "delete", Route = "eliminarpersona/{id}")] HttpRequestData req,
    int id)
        {
